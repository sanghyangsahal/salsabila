				...
				<section class="content">
					...
					<header class="header">
						...
						<div class="h-right">
							...
							<h4 class="subhead"><a href="#register">Registrasi Belum di buka</a></h4>
						</div>
					</header>
				</section>
            ...
            <div class="section page-register page page-cent"  id="s-register">
                <section class="content">
                    ...
                    <div>
								...
								<div class="buttons">
									<a href="https://goo.gl/forms/6aZVa78s2mW5RvyI3" target="_blank"><button class="button" name="submit_email">Ok</button></a>
								</div>
